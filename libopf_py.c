/* Generated by Cython 0.13 on Wed Aug 10 15:45:04 2011 */
...
static PyObject *__pyx_pf_9libopf_py_3OPF_fit(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (values[2]) {
      __pyx_v_metric = __Pyx_PyInt_AsInt(values[2]); if (unlikely((__pyx_v_metric == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    } else {
      __pyx_v_metric = ((int)0);
    }
  } else {
    __pyx_v_metric = ((int)0);
    switch (PyTuple_GET_SIZE(__pyx_args)) {
      case  3:
      __pyx_v_metric = __Pyx_PyInt_AsInt(PyTuple_GET_ITEM(__pyx_args, 2)); if (unlikely((__pyx_v_metric == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 20; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      case  2:
 ...
 * 
 */
  __pyx_t_1 = (!subgraph_set_data(((struct __pyx_obj_9libopf_py_OPF *)__pyx_v_self)->sg, ((float *)__pyx_v_X->data), ((int *)__pyx_v_Y->data), ((int)(__pyx_v_X->dimensions[0])), ((int)(__pyx_v_X->dimensions[1]))));
  if (__pyx_t_1) {
 ...
 */
  subgraph_set_metric(((struct __pyx_obj_9libopf_py_OPF *)__pyx_v_self)->sg, ((enum METRIC)__pyx_v_metric));
...
static PyObject *__pyx_pf_9libopf_py_3OPF_predict(PyObject *__pyx_v_self, PyObject *__pyx_v_X) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_X, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_X = __pyx_bstruct_X.strides[0]; __pyx_bstride_1_X = __pyx_bstruct_X.strides[1];
  __pyx_bshape_0_X = __pyx_bstruct_X.shape[0]; __pyx_bshape_1_X = __pyx_bstruct_X.shape[1];
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_to_py_Py_intptr_t((((PyArrayObject *)__pyx_v_X)->dimensions[0])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_5 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__int32); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_5 = PyEval_CallObjectWithKeywords(__pyx_t_2, __pyx_t_3, ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
